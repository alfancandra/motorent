                    ...
                    <div class="modal fade show" id="editRowModal" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p class="small">Create a new row using this form, make sure you fill them all</p>
                                    <form action="{{ route('motor.update',$find->id) }}" method="post" enctype="multipart/form-data">
                                        @method('PUT')
                                        @csrf
                                        <div class="row">
                                            <div class="col-sm-12">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-button-action">
                                            <a href="{{ route('motor.edit',$item['id']) }}" class="btn btn-link btn-primary btn-lg" data-original-title="Edit Task">
